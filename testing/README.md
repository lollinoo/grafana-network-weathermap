...
The Grafana instance will be pointed to `localhost:3101`. Upon opening, you will find a small test layout of the plugin layed out, already connected to the Prometheus instance. Feel free to edit and play around as you please.
...
\* This testing stack now uses `grafana/grafana:latest` by default so the plugin can be validated against recent Grafana releases.
